		...
		<form id="form-user-add" >
			<table class="table table-hover table-condensed" >
				<tr>
					...
					<td >
					<input type="text" class="input30 require" length="1,32" label-name="卡号" name="objBean.id"/>
					</td>
				...
				<tr>
					...
					<td>
					  <select class="select30 require" label-name="车辆所属公司" name="objBean.vehicleCompany" id="slt_company" >
					  </select>
					</td>
					<!--  
	...
	function loadUserAddJs() {
		...
		$("#add_user_btn").click(function() {
			if(checkForm("#form-user-add",'right')) {
				...
				$.post("vehicle/add",reqData, function(json) {
					cu.toast.close();
