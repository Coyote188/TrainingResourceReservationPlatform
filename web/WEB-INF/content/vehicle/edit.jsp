		...
		<form id="form-user-add" >
			...
			<table class="table table-hover table-condensed" >
				<tr>
					...
					<td >
					<input type="text" class="input30 require" length="1,32" label-name="卡号" name="objBean.id" value="${objBean.id }"/>
					</td>
					<td class="td-col1">车牌号</td>
					<td>
					<input type="text" class="input30 require" length="1,6" label-name="车牌号" name="objBean.licensePlate"  value="${objBean.licensePlate }"/>
					</td>
				</tr>
				<tr>
					<td class="td-col1">车架号</td>
					<td >
					<input type="text" class="input30 require" length="1,32" label-name="车架号" name="objBean.frameNbr" value="${objBean.frameNbr }"/>
					</td>
					<td class="td-col1">车主</td>
					<td >
					<input type="text" class="input30 require" length="1,32" label-name="车主" name="objBean.owner" value="${objBean.owner }"/>
					</td>
				</tr>
				<tr>
					<td class="td-col1">联系人</td>
					<td >
					<input type="text" class="input30 require" length="1,32" label-name="联系人" name="objBean.contacts" value="${objBean.contacts }"/>
					</td>
					<td class="td-col1">联系电话</td>
					<td >
					<input type="text" class="input30 require" length="1,32" label-name="联系电话" name="objBean.contactNbr" value="${objBean.contactNbr }"/>
					</td>
				</tr>
				<tr>
					<td class="td-col1">车辆所属公司</td>
					<td>
					  <select class="select30 " label-name="车辆所属公司" name="objBean.vehicleCompany" id="slt_company" value="${objBean.vehicleCompany }">
					  </select>
					</td>
					<!--  
					<td class="td-col1">维修站</td>
					<td>
...
<script type="text/javascript">
	...
	function loadUserAddJs() {
		selectDictItem("#slt_company","CAR_BELONG","${objBean.vehicleCompany }");
