		...
		<form id="form-user-add" >
			<table class="table table-hover table-condensed" >
				...
				<tr>				
					...
					<td >
					<input type="text" class="input30 require" length="1,32" label-name="维修保养人名称" name="objBean.userName"/>
					</td>
				</tr>
				<tr>
					<td class="td-col1">联系电话</td>
					<td >
					<input type="text" class="input30 " length="1,32" label-name="联系电话" name="objBean.mobileNo"/>
					</td>
				</tr>
				<tr>
...
<script type="text/javascript">
	...
	function loadUserAddJs() {
		selectDictItem("#v_state_id","DATA_STATE","");
		userAddinitZnodes();
		...
		$("#add_user_btn").click(function() {
			if(checkForm("#form-user-add",'right')) {
				...
				$.post("repairPerson/add",reqData, function(json) {
					cu.toast.close();
