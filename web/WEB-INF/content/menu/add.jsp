		...
		<form id="form-add">
			<table class="table table-hover table-condensed">
				<tr>
					...
					<td><input type="text" class="input30 require" label-name="菜单名称" name="objBean.menuName" />
					</td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td>
					   <input type="text" class="input30" name="objBean.uri" />
					</td>
				</tr>
				<tr>
...
cu.layout.formActive();
	...
	$("#form-add").submit(function() {
	    if(checkForm("#form-add",'right')) {
			...
			$.post("menu/add", list, function(json) {
				cu.toast.close();
				var output = $.parseJSON(json.output);
				cu.toast(output.msg);
				if(output.result == '1') {
