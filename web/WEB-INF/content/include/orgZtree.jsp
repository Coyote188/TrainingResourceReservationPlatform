...
var include_setting = {
		...
		callback: {
			onClick : function (e, treeId, treeNode) {
				...
				if(flag == "true")
					name =name+"(合)";
				loadUri("#cu-org-content","user/list?orgId="+id+"&flag="+flag+"&orgSeqName="+ encodeURI(name));
			}
		},
		myQuery:{
			enable :true,
...
$(document).ready(function() {
	...
	<div id="cu_org" class="nav-left-org">
	    <h4 class="ui-widget-header ui-corner-top area_title">组织机构 
	    	<span style="margin-left:80px; cursor: auto;"><input id="totCheck" checked="checked" type="checkbox" style="margin-bottom: 5px;"  value="1">&nbsp;<label for="totCheck">涵盖查询</label></span>
	    </h4>
