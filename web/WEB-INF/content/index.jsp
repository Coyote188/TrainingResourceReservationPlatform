...
.recommend-list .menu {
	height: 32px;
	width: 100%;
	background: url(images/qhbg2.jpg) no-repeat left center;
	background-size: 100%;
}

.recommend-list .menu ul {
	margin: 0px;
	padding: 0px;
	height: 26px;
	list-style: none;
...
.recommend-list .menu li a {
	color: #000000;
	font-size: 14px;
	text-decoration: none;
	display: block;
	background: url("images/hovbg2.jpg") no-repeat scroll left bottom/100%
		auto;
}

.recommend-list .menu li a.tabactive {
	color: #268bdd;
	font-weight: bold;
	height: 27px;
	background: url(images/hovbg2.jpg) no-repeat left bottom/100%;
}

.recommend-list .tabdiv ul {
	list-style: none;
}

.recommend-list .tabdiv ul li {
	height: 24px;
	line-height: 24px;
	overflow: hidden;
	background: url(images/linarr.jpg) no-repeat left center;
	text-indent: 15px;
}

.recommend-list .tabdiv ul li a {
	text-decoration: none;
	color: #000000;
}

.recommend-list .tabdiv ul li a:hover {
	color: #ff0000;
}

.recommend-list .tabfirstli {
	margin-left: 8px;
}

.recommend-list .tabdiv {
	font-size: 12px;
	height: 228px;
	padding: 10px;
	position: absolute;
...
$.extend({
	...
	fnRecommendList: function(dataType, container){
    	...
    	$.post(url,req,function(data, status){
			...
			//		html += '<tr><td class="left">'+rec[1]+'</td><td class="right">'+'<a onclick="$.fnOpenReader(\'' + rec[0] + '\');">'+rec[2]+'</td></tr>';
					html +=recommend;		
					html += '</td></tr>';
				});
...
<section class="rt_wrap content mCustomScrollbar">
	...
	<div class="rt_content">
		<div class="admin_tab_cont" style="display: block;">
			<!--左右分栏：左侧栏目-->
			<div class="cont_col_lt mCustomScrollbar" style="height: 700px;">
				<h2>
					<strong style="color: grey;">学习历史</strong>
				</h2>
				<div id="learnRecorderList"></div>
			</div>
			<!--左右分栏：右侧栏-->
			<div class="cont_col_rt">
				<div id="chartsTestHistory"
		  ...
		  $(".admin_tab_cont").eq(liindex).fadeIn(150).siblings(".admin_tab_cont").hide();
				...
				<section >
					<ul class="admin_tab">
						...
						<li><a id="tablinkh1" class="active"
							onclick="$.showThis(1,'divNumberh','tabContenth','tablinkh');"
							href="javascript:void(0);">最近上传</a></li>
						<li><a id="tablinkh2"
							onclick="$.showThis(2,'divNumberh','tabContenth','tablinkh');"
							href="javascript:void(0);">最多收藏</a></li>
					</ul>
					<!--tabCont-->
					<div class="admin_tab_cont content mCustomScrollbar" style="display: block;height: 250px;">
						<div class="tabdiv" name="divNumberh" id="tabContenth1">
							<ul id="ulRecommendList1">
							</ul>
						</div>
					</div>
					<div class="admin_tab_cont content mCustomScrollbar" style="height: 250px;">
...
<div id="dvFilePlayer"
	style="margin-left: 2px; overflow: auto; width: 99%;" hidden="hidden">
