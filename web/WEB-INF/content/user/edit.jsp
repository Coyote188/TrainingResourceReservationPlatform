		...
		<form id="form-user-add" >
			...
			<table class="table table-hover table-condensed" >
				<tr>
					...
					<td >
					<input type="text" class="input30 require" length="1,32" label-name="用户名" value="${objBean.userName}" name="objBean.userName"/>
					</td>
					<td class="td-col1">姓名(中文)</td>
					<td>
					<input type="text" class="input30 require" length="1,15" label-name="用户名" data-format="chinese" value="${objBean.callName}" name="objBean.callName" />
					</td>
				</tr>
				...
				<tr>
					...
					<td>
						<select id="user_state_id" class="select30" label-name="状态"  name="objBean.state">
						</select>
					</td>
					...
					<td>
						...
						<input id="orgId" value="${objBean.orgId}" name= "objBean.orgId" value="" type="hidden" >					
					</td>
				</tr>
				<tr>
					<td class="td-col1">岗位</td>
					<td>
					  <select class="select30 " label-name="岗位" value="${objBean.postName }" name="objBean.postName" id="post_id" >
					  </select>
					</td>
					<td class="td-col1">职称</td>
					<td>
					  <select class="select30 " label-name="职称" value="${objBean.profeName }" name="objBean.profeName" id="profe_id" >
					  </select>
					</td>
				</tr>
				<tr>
					...
					<td>
					<input type="text" class="input30 " label-name="手机" data-format="phone" value="${objBean.mobileNo }" name="objBean.mobileNo" />
					</td>
					<td class="td-col1">固定电话</td>
					<td>
					<input type="text" class="input30 " length="1,20" label-name="固定电话" value="${objBean.telephone }" name="objBean.telephone" />
					</td>
				</tr>
				<tr>
					<td class="td-col1">QQ</td>
					<td>
					<input type="text" class="input30 " label-name="QQ" length="1,15" value="${objBean.qqNo }" name="objBean.qqNo" />
					</td>
					<td class="td-col1">邮箱</td>
					<td>
					<input type="text" class="input30 " length="1,30" data-format="email" label-name="邮箱" value="${objBean.email }" name="objBean.email" />
					</td>
				</tr>
				<tr>
					<td class="td-col1">备注</td>
					<td colspan="3">
						 <textarea type="text" id="input3" class="form-control " style="width: 90%;" label-name="备注"  length="1,100" value="${objBean.remark }" name="objBean.remark" />
					</td>
				</tr>
				<tr>
					<td colspan="4">
	...
	function loadUserAddJs() {
		...
		$("#add_user_btn").click(function() {
			if(checkForm("#form-user-add",'right')) {
				...
				$.post("user/edit",reqData, function(json) {
					cu.toast.close();
