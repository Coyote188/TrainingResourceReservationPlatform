      ...
      <form id="role-form-add">
         <table class="table table-hover table-condensed">
			<tr>
				...
				<td>
					<input type="text" class="input30 " length="1,100" label-name="角色描述" name="objBean.roleDes"/>
				</td>
				<td>
					<input id="add_roleCom_btn" type="button" class="button" value="保存"/>
				</td>
			</tr>
		 </table>
      </form>
...
cu.layout.formActive();
	...
	$("#add_roleCom_btn").click(function() {
	    if(checkForm("#role-form-add",'top')) {
			...
			$.post("role/addRoleCom",reqData, function(json) {
				cu.toast.close();
				...
				view: {
					addDiyDom: function(treeId, treeNode) {
						...
						//alert(treeNode.tId);
							...
							html.push(" <label class='childCheckbox'><input ptid='"+treeNode.tId+"' class=\"operates\" type=\"checkbox\" name=\"operates\" "+($.inArray(op.id,operates)!=-1?" checked":"")+" value=\""+op.menuId+";"+op.val+"\">&nbsp;"+op.name+"&nbsp;</label>");
						}
						//alert(html);
