		...
		$.post("exam/myQuestionList",null,function(data, status){
			...
			if(res.result =="1"){
				...
				$.each(res.data,function(index, line){
					...
					tr += '<input type="button" class="button green" style="width:60px; margin: 5px 0 5px 0" value="修改" onclick="$.fnQuestionUpdate(\'' + line[0] + '\')">';
...
<div style="border-bottom: 1px solid #c6c7c2;border-left: 1px solid #c6c7c2;border-right: 1px solid #c6c7c2; border-radius:5px; color:#428bca; margin-left: 10px; overflow-y: scroll;">
	<!-- 问题清单 -->
